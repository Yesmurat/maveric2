...
if __name__ == '__main__':
    input_directory = ['test/tests/dis-asm/am-kernels', 'test/tests/dis-asm/riscv-arch-test', 'test/tests/dis-asm/riscv-tests', 'test/tests/dis-asm/snippy', 'test/tests/dis-asm/custom']
